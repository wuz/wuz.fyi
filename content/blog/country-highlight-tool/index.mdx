...
country. This method can be used for any kind of Mapbox tileset, but we're using data
...
account and click into the Account button on the bottom left of the dashboard. Then on API
